...
function removeTransition(e) { //we need this because we want to remove the playing class after the transition ends so it wont get out of sync, since we have transition in our css file.
